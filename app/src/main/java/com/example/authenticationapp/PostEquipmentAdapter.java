...
public class PostEquipmentAdapter extends FirebaseRecyclerAdapter<PostModel,PostEquipmentAdapter.ViewHolder> {

    private Context context;
    public PostEquipmentAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
