...
public class PostFoodAdapter extends FirebaseRecyclerAdapter<PostModel,PostFoodAdapter.ViewHolder> {

    private Context context;
    public PostFoodAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
