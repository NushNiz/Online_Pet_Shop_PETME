...
public class userToysAdapter extends FirebaseRecyclerAdapter<PostModel,userToysAdapter.ViewHolder> {

    private Context context;
    public userToysAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull userToysAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull PostModel model) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference().child("Toy")
    ...
    @Override
    public userToysAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_desgin, parent,false);

        return new userToysAdapter.ViewHolder(view);
    }
