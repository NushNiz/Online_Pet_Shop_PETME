...
public class UserToysPosts extends AppCompatActivity {

    RecyclerView recyclerView;
    userToysAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_toys_posts);
        ...
        adapter=new userToysAdapter(options,this);
        adapter=new userToysAdapter(options1,this);
        recyclerView.setAdapter(adapter);
    }

    private void backtoHome() {
        Intent intent = new Intent(UserToysPosts.this, MainActivity.class);
        startActivity(intent);
    }

    public void adduToys(View view){
        Intent intent1 = new Intent(UserToysPosts.this, userToysProfile.class);
