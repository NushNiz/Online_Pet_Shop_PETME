...
public class PostMediAdapter extends FirebaseRecyclerAdapter<PostModel,PostMediAdapter.ViewHolder> {

    private Context context;
    public PostMediAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
