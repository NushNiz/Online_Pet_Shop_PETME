...
public class PostWantedAdapter extends FirebaseRecyclerAdapter<PostModel,PostWantedAdapter.ViewHolder> {
    private Context context;
    public PostWantedAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
