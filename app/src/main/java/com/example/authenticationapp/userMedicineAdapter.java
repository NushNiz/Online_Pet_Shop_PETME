...
public class userMedicineAdapter extends FirebaseRecyclerAdapter<PostModel,userMedicineAdapter.ViewHolder> {

    private Context context;
    public userMedicineAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull userMedicineAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull PostModel model) {
    ...
    @Override
    public userMedicineAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
