...
public class userPetAdapter extends FirebaseRecyclerAdapter<PostModel,userPetAdapter.ViewHolder> {

    private Context context;
    public userPetAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
