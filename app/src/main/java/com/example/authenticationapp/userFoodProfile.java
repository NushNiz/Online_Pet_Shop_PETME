...
public class userFoodProfile extends AppCompatActivity {
    ...
    private void BackToHome() {
        Intent intent = new Intent(userFoodProfile.this, MainActivity.class);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Intent intent = new Intent(userFoodProfile.this,RecycleViewFood.class);
                                    startActivity(intent);
    ...
    public void sendMesssage(View view){
        Intent intent = new Intent(userFoodProfile.this,RecycleViewList.class);
        startActivity(intent);
