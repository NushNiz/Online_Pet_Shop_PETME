...
public class UserPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new userPetAdapter(options,this);
        adapter=new userPetAdapter(options1,this);
        recyclerView.setAdapter(adapter);
    }

    private void backtoHome() {
        Intent intent = new Intent(UserPosts.this, MainActivity.class);
        startActivity(intent);
    }

    public void addPet(View view){
        Intent intent1 = new Intent(UserPosts.this, userPetProfile.class);
