...
public class userFoodAdapter extends FirebaseRecyclerAdapter<PostModel,userFoodAdapter.ViewHolder> {

    private Context context;
    public userFoodAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull userFoodAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull PostModel model) {
