...
public class userWantedAdapter extends FirebaseRecyclerAdapter<PostModel,userWantedAdapter.ViewHolder> {

    private Context context;
    public userWantedAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull userWantedAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull PostModel model) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference().child("Wanted")
    ...
    @Override
    public userWantedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_desgin, parent,false);

        return new userWantedAdapter.ViewHolder(view);
    }
