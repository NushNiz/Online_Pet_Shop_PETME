...
public class userEquipAdapter extends FirebaseRecyclerAdapter<PostModel,userEquipAdapter.ViewHolder> {

    private Context context;
    public userEquipAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull userEquipAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull PostModel model) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference().child("Equipment")
    ...
    @Override
    public userEquipAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_desgin, parent,false);

        return new userEquipAdapter.ViewHolder(view);
    }
