...
public class userEquipProfile extends AppCompatActivity {
    ...
    private void BackToHome() {
        Intent intent = new Intent(userEquipProfile.this, MainActivity.class);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Intent intent = new Intent(userEquipProfile.this,RecyclerViewEquipment.class);
                                    startActivity(intent);
    ...
    public void sendMesssage(View view){
        Intent intent = new Intent(userEquipProfile.this,RecycleViewList.class);
        startActivity(intent);
