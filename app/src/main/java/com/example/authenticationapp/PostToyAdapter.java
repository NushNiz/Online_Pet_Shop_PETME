...
public class PostToyAdapter extends FirebaseRecyclerAdapter<PostModel,PostToyAdapter.ViewHolder> {

    private Context context;
    public PostToyAdapter(@NonNull FirebaseRecyclerOptions<PostModel> options, Context context) {
        super(options);
